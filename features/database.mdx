...
<Tip>Take advantage of thh SQL editor in Supabase. You can limit the complexity of your app's codebase by creating views and functions in your database!</Tip>
