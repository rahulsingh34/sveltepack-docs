...
<AccordionGroup>
    ...
    <Accordion title="Reset Password">
        ...
        <Step title="Configure Site URL">
            ...
            <p><a href="{{ .SiteURL }}/update-password">Reset Password</a></p>
            ```
            You may wish to change the styling but ensure that the your redirect link points to `{{ .SiteURL }}/update-password` as shown above
        </Step>
        </Steps>
